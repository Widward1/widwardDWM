...
static const char col_pink[]        = "#fca4ca";
static const char col_dblue[]       = "#04004d";
static const char col_lblue[]       = "#02e8d9";
static const char *colors[][3]      = {
	/*   fg (text)    bg (behind text)        border   */
	[SchemeNorm] = { col_lblue, col_gray1, col_gray2 },
...
;static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_c,      spawn,          {.v = chromcmd } },
